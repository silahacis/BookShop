...
import com.bookstore.bookstoreapp.data.Product
    ...
    object ProductRepository {
        private val products = listOf(
            ...
            Product(5,R.drawable.yakin_tarih_history, "Yakın Tarihin Gerçekleri", "İlber Ortaylı", "155 ", "History",
            ...
            Product(12,R.drawable.woods_mystery, "In The Woods", "Tana French", "105 ", "Mystery",
