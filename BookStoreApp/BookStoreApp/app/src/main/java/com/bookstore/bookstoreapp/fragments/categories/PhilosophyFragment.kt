...
class PhilosophyFragment : BaseCategoryFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Fetch horror books
        val philosophyBooks = ProductRepository.getProductsByCategory("Philosophy")

        val adapter = ProductsAdapter(philosophyBooks){selectedProduct ->
